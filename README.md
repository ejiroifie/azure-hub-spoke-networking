...
![Spoke-Dev Peerings – Connected](screenshots/phase3-spoke-dev-peerings-connected.png)  
...
![Bastion Overview – Running](screenshots/phase4-bastion-overview-running.png)  
...
![Bastion RDP Session Open](screenshots/phase5-bastion-rdp-session-open.png)  
*Secure Bastion RDP session to VM*

![VM Isolation – Ping Timeout](screenshots/phase5-vm-isolation-ping-timeout.png)  
*Ping from Dev VM to Prod VM private IP fails (timeout)*

![Firewall Test – Microsoft Allowed](screenshots/phase5-firewall-test-browser-microsoft-success.png)  
*Browser loads microsoft.com (allowed by rule)*

![Firewall Test – Facebook Blocked](screenshots/phase5-firewall-test-browser-facebook-blocked.png)  
*Browser fails to load facebook.com (blocked by Firewall default deny)*

![PowerShell – Microsoft TCP Test](screenshots/phase5-powershell-test-netconnection-microsoft-true.png)  
*Test-NetConnection microsoft.com Port 443 → True (TCP handshake allowed)*

![PowerShell – Facebook TCP Test](screenshots/phase5-powershell-test-netconnection-facebook-true.png)  
